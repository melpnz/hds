...
- `ui/organisms.css:75` — `grid-template-columns`

## `240px` · composite-or-unsupported-property

Всего: 1.

- `ui/page-reconstructions.css:54` — `grid-template-columns`

## `260px` · composite-or-unsupported-property

Всего: 4.

- `ui/page-reconstructions.css:4` — `grid-template-columns`
- `ui/page-reconstructions.css:13` — `grid-template-columns`
- `ui/page-reconstructions.css:73` — `grid-template-columns`
- `ui/page-reconstructions.css:80` — `grid-template-columns`

## `280px` · composite-or-unsupported-property

Всего: 2.

- `ui/blocks.css:22` — `grid-template-columns`
- `ui/blocks.css:52` — `grid-template-columns`

## `360px` · composite-or-unsupported-property
