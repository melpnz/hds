...
`.input` дополнительно несёт утилитарный класс `visually-hidden` — сам
input визуально скрыт, но остаётся в потоке доступности; видимый квадрат
рисует `.indicator`, соседний элемент.
