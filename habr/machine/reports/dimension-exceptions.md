# habr · исключения размерных токенов
...
- `ui/layout.css:151` — `letter-spacing`
...
- `ui/components/section-name.css:23` — `token:space`

## `-23px` · tokenized-off-grid-value

Всего: 3.

- `ui/components/hint.css:93` — `token:size`
- `ui/components/hint.css:96` — `token:size`
- `ui/components/hint.css:98` — `token:size`
...
- `ui/layout.css:139` — `token:size`
- `ui/components/article-card.css:338` — `token:space`
...
- `ui/components/article-card.css:196` — `token:space`
- `ui/components/article-card.css:337` — `token:space`
- `ui/components/votes.css:37` — `token:space`
- `ui/components/votes.css:81` — `token:space`
- `ui/components/votes.css:102` — `token:space`

## `7px` · tokenized-off-grid-value

Всего: 1.

- `ui/components/checkbox.css:74` — `token:size`
...
- `ui/layout.css:112` — `token:font-size`
- `ui/layout.css:221` — `token:font-size`
...
- `ui/components/hint.css:170` — `token:space`
- `ui/components/input.css:46` — `token:space`
- `ui/components/section-name.css:12` — `token:space`
- `ui/components/section-name.css:17` — `token:space`
- `ui/components/textarea.css:31` — `token:space`
- `ui/layout.css:176` — `token:space`
...
- `ui/components/radio.css:27` — `token:size`
- `ui/components/radio.css:28` — `token:size`
- `ui/layout.css:132` — `token:size`
- `ui/layout.css:139` — `token:size`
...
- `ui/components/badges.css:3` — `token:space`

## `22px` · tokenized-off-grid-value

Всего: 1.

- `ui/layout.css:92` — `token:size`

## `26px` · tokenized-off-grid-value

Всего: 2.

- `ui/components/button-follow.css:33` — `token:size`
- `ui/components/button-follow.css:41` — `token:size`

## `30px` · tokenized-off-grid-value

Всего: 2.

- `ui/components/chip.css:59` — `token:size`
- `ui/components/chip.css:144` — `token:size`
...
- `ui/components/calendar.css:78` — `token:size`

## `49px` · tokenized-off-grid-value

Всего: 1.

- `ui/components/pagination.css:14` — `token:size`

## `57px` · tokenized-off-grid-value

Всего: 1.

- `ui/layout.css:95` — `token:size`

## `62px` · tokenized-off-grid-value

Всего: 1.

- `ui/layout.css:94` — `token:size`

## `150px` · tokenized-off-grid-value

Всего: 1.

- `ui/components/primitives.css:118` — `token:size`

## `289px` · tokenized-off-grid-value

Всего: 1.

- `ui/components/hint.css:204` — `token:size`

## `338px` · tokenized-off-grid-value

Всего: 1.

- `ui/components/votes.css:127` — `token:size`
