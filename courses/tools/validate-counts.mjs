...
const claims = [
  ...
  // Два правила о CHANGELOG.md сняты 11 сентября 2026 (R2-bulk). Они сверяли
  // с текущим состоянием запись инвентаризации 7 сентября — «78 шагов»,
  // «55 элементов». Запись журнала описывает момент, когда её сделали, и
  // когда реестр вырос до 67, правило требовало переписать историю, а не
  // исправить ложь. Текущие числа по-прежнему сторожатся в README.md и
  // ROADMAP.md — там, где они заявлены как текущие.
