...
Лента карточек «Рекомендуем вам» не переносится: при нехватке ширины она прокручивается горизонтально внутри тела модалки, не создавая горизонтальный scroll у всей страницы.
