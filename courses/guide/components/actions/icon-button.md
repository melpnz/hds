...
| **Живая реализация** | [`viewer/index.html#icon-button`](../../../viewer/index.html#icon-button) |
...
- **Pressed.** Не входит в обязательный контракт IconButton по решению review-квиза 18 сентября 2026.
