...
| **Живая реализация** | [`viewer/index.html#person-card`](../../../viewer/index.html#person-card) |
...
`div` со сквозной ссылкой `a.z-2.absolute` на профиль; биография у 26 карточек из 30 обрезана градиентной вуалью, у 4 — короткая и идёт целиком.

## Управление клавиатурой

Корень (`<div>`) в фокус не попадает. На один экземпляр по Tab проходят: 2 ссылки — у 12 из 30; 3 ссылки — у 11 из 30; 4 ссылки — у 4 из 30; 5 ссылок — у 3 из 30. По корпусу (88 узлов): `Link` — 88.
