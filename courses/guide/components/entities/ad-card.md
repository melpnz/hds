...
| **Живая реализация** | [`viewer/index.html#ad-card`](../../../viewer/index.html#ad-card) |
...
**Правило.** Рекламный слайд в `AdSlot`: картинки для десктопа и мобильного. У 20 слайдов из 52 — метка «РЕКЛАМА» и кнопка «ещё» с плашкой маркировки, у остальных 32 — только картинки. В продукте 52 узла на 4 страницах, все в `Carousel`.
...
Корень (`<div>`) в фокус не попадает. На один экземпляр по Tab проходят: ничего — у 31 из 52; 1 кнопка — у 17 из 52; 1 кнопка и 1 ссылка — у 3 из 52; 1 ссылка — у 1 из 52. По корпусу (24 узла): `Link` — 4; вне записей реестра — `button.absolute.right-3.top-3.z-10` — 20.
...
Классы с префиксом ширины в поддереве записи: `phone:hidden`, `phone:!block`, `phone:aspect-[272/280]`, `phone:w-full`. Условия префиксов: `phone:` — до 767 (`docs/guide/layout.md`).
