...
| **Живая реализация** | [`viewer/index.html#rating-table`](../../../viewer/index.html#rating-table) |
...
**Правило.** Используйте для рейтинга школ: строка — номер, логотип, название, оценка, число курсов и отзывов. В продукте 2 узла на 2 страницах.

## Когда не использовать

- Для карточной выдачи школ — `SchoolCard`.
...
Корень (`<div>`) в фокус не попадает. На один экземпляр по Tab проходят: 10 ссылок — у 1 из 2; 1 кнопка и 20 ссылок — у 1 из 2. По корпусу (31 узел): `Link` — 30, `Button` — 1.
