...
| **Живая реализация** | [`viewer/index.html#avatar-stack`](../../../viewer/index.html#avatar-stack) |
...
три аватара 24×24 rounded-full с белой рамкой 1px, перекрытие -6px, замыкает `Chip variant="counter"`
...
`div.flex.-space-x-1.5`: аватары с наложением и `Chip variant="counter"` в конце. Состав фиксирован — три аватара и счётчик.
