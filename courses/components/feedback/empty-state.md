...
| **Живая реализация** | [`showcase/components.html#c-empty-state`](../../showcase/components.html#c-empty-state) |
...
- **Состояния не сняты.** Требуемые состояния записи (`default`) в макете отдельными вариантами не нарисованы, а измерить их негде. Разбор — [`components/STATE-CAPTURE.md`](../STATE-CAPTURE.md).
