...
Корень (`<div>`) в фокус не попадает. На один экземпляр по Tab проходят: 6 кнопок и 1 ссылка — у 2 из 5; ничего — у 1 из 5; 14 кнопок и 1 ссылка — у 1 из 5; 2 кнопки и 1 ссылка — у 1 из 5; у остальных 1 — другой состав. По корпусу (32 узла): `IconButton` — 8, `Link` — 4, внутри `AdCard` — 20.
