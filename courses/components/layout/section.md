...
`<section>` с `h2` 24 / 28, 600, −0.5 и слотом, промежуток 16. Между секциями 48, на страницах экспертов, редакции и профиля — 40.

## Управление клавиатурой

Корень (`<section>`) в фокус не попадает. С клавиатуры доступны вложенные записи: `Link` ×151, `FilterChip` ×107, `Button` ×70, `IconButton` ×24 — у каждой свой раздел.
