...
`div.cursor-pointer` со сквозной ссылкой `a.z-1.absolute` на страницу школы под кнопкой.

## Управление клавиатурой

Корень (`<div>`) в фокус не попадает. С клавиатуры доступны вложенные записи: `Button` ×48, `Link` ×48 — у каждой свой раздел.
