...
Корень (`<div>`) в фокус не попадает. На один экземпляр по Tab проходят: 2 ссылки — у 12 из 30; 3 ссылки — у 11 из 30; 4 ссылки — у 4 из 30; 5 ссылок — у 3 из 30; у остальных 3 — другой состав. По корпусу (88 узлов): `Link` — 88.
