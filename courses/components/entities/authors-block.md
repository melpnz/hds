...
| **Живая реализация** | [`showcase/components.html#c-authors-block`](../../showcase/components.html#c-authors-block) |
...
Классы с префиксом ширины в поддереве записи: `phone:flex-col`, `tablet:grid-cols-1`. Условия префиксов: `phone:` — до 767, `tablet:` — до 1023 (`docs/guide/layout.md`).
