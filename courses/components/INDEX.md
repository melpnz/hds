...
уже сейчас: 45 элементов сняты с продакшена, 5 есть только в Storybook, 5 —
только в макете.
...
| `figma-only` | 5 | в снятой разметке продакшена не найден; описывается по макету |
...
(45 / 5 / 5) сверяются в обоих местах, где написаны, прозой и таблицей.
