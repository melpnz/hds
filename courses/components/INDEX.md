...
R0-05 и дополнен 11 сентября 2026. Записей — 71. Написано **71** спецификаций, по одной на каждую: 28 в статусе `complete` (`SpriteIcon` — R2-01 по полному циклу, остальные —
bulk-проходом после двух кругов ревью прозы), 22 в статусе `partial`
...
таблице состояний спецификации) или проза ещё не прошла повторную проверку
после правки.
