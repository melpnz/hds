...
R0-05. Записей — 55. Написано **50** спецификаций: одна доведённая до `complete` —
`SpriteIcon` (R2-01, первый шаг вёрстки волны R2), 47 в статусе `partial`
и две в терминальном `figma-only` (`Breadcrumbs`, `EmptyState`) — их разметка
