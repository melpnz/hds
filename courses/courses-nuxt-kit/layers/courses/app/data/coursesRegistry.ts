...
export const coursesRegistry: CoursesRegistryEntry[] = [
  ...
  entry('filter-chip', 'FilterChip', 'forms', 'component', 'complete', ['default', 'hover', 'focus-visible', 'pressed', 'disabled', 'loading', 'open'], { count: 24 }, 'Программирование'),
  ...
  entry('switch', 'Switch', 'forms', 'component', 'complete', ['default', 'hover', 'focus-visible', 'checked', 'disabled', 'loading'], { label: 'Только со скидкой' }),
  ...
  entry('button-group', 'ButtonGroup', 'navigation', 'component', 'complete', ['light', 'hero', 'compact', 'block', 'hover', 'focus-visible', 'selected', 'disabled']),
