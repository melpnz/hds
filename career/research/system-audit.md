...
Действующая версия — [`../docs/guide/composition.md`](../docs/guide/composition.md) §1. Ниже она приведена
...
> **Нормативные формулировки переехали в [`../docs/guide/composition.md`](../docs/guide/composition.md).**
...
Шесть параметров не зависят от ширины — перечислены в [`../docs/guide/composition.md`](../docs/guide/composition.md) §11.
